...
class StrontiumDataScreen extends StatefulWidget {
  final int aquariumId;

  StrontiumDataScreen({required this.aquariumId});

  @override
  _StrontiumDataScreenState createState() => _StrontiumDataScreenState();
}

class _StrontiumDataScreenState extends State<StrontiumDataScreen> {
  ...
  Widget _makeLineChartWidget(List<WaterValue> waterValues) {
    ...
    double yDeviation = 10.0; // Example deviation for Strontium
    return LineChartWidget(
      xValues: xValues,
      yValues: yValues,
      yDeviation: yDeviation,
      fractionDigits: 1,
      title: 'Strontium Levels over Time',
      xAxisLabel: 'Time',
      yAxisLabel: 'Strontium (mg/L)',
    );
  }
