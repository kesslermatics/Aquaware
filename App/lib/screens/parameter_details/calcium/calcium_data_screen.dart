...
class CalciumDataScreen extends StatefulWidget {
  final int aquariumId;

  CalciumDataScreen({required this.aquariumId});

  @override
  _CalciumDataScreenState createState() => _CalciumDataScreenState();
}

class _CalciumDataScreenState extends State<CalciumDataScreen> {
  ...
  Widget _makeLineChartWidget(List<WaterValue> waterValues) {
    ...
    double yDeviation = 10.0; // Example deviation for Calcium
