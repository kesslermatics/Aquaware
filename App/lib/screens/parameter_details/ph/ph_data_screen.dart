...
class PHDataScreen extends StatefulWidget {
  final int aquariumId;

  PHDataScreen({required this.aquariumId});

  @override
  _PHDataScreenState createState() => _PHDataScreenState();
}

class _PHDataScreenState extends State<PHDataScreen> {
