...
class AlkalinityDataScreen extends StatefulWidget {
  final int aquariumId;

  AlkalinityDataScreen({required this.aquariumId});

  @override
  _AlkalinityDataScreenState createState() => _AlkalinityDataScreenState();
}

class _AlkalinityDataScreenState extends State<AlkalinityDataScreen> {
