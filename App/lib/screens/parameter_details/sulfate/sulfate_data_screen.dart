...
class SulfateDataScreen extends StatefulWidget {
  final int aquariumId;

  SulfateDataScreen({required this.aquariumId});

  @override
  _SulfateDataScreenState createState() => _SulfateDataScreenState();
}

class _SulfateDataScreenState extends State<SulfateDataScreen> {
  ...
  Widget _makeLineChartWidget(List<WaterValue> waterValues) {
    ...
    double yDeviation = 10.0; // Example deviation for Sulfate
    return LineChartWidget(
      xValues: xValues,
      yValues: yValues,
      yDeviation: yDeviation,
      fractionDigits: 1,
      title: 'Sulfate Levels over Time',
      xAxisLabel: 'Time',
      yAxisLabel: 'Sulfate (mg/L)',
    );
  }
