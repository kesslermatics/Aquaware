...
class BoronDataScreen extends StatefulWidget {
  final int aquariumId;

  BoronDataScreen({required this.aquariumId});

  @override
  _BoronDataScreenState createState() => _BoronDataScreenState();
}

class _BoronDataScreenState extends State<BoronDataScreen> {
  ...
  Widget _makeLineChartWidget(List<WaterValue> waterValues) {
    ...
    double yDeviation = 0.1; // Example deviation for Boron
    return LineChartWidget(
      xValues: xValues,
      yValues: yValues,
      yDeviation: yDeviation,
      fractionDigits: 2,
      title: 'Boron Levels over Time',
      xAxisLabel: 'Time',
      yAxisLabel: 'Boron (mg/L)',
    );
  }
