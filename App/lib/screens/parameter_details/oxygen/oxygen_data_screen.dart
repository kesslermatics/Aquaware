...
class OxygenDataScreen extends StatefulWidget {
  final int aquariumId;

  OxygenDataScreen({required this.aquariumId});

  @override
  _OxygenDataScreenState createState() => _OxygenDataScreenState();
}

class _OxygenDataScreenState extends State<OxygenDataScreen> {
  ...
  Widget _makeLineChartWidget(List<WaterValue> waterValues) {
    ...
    double yDeviation = 1.0; // Example deviation for Oxygen
