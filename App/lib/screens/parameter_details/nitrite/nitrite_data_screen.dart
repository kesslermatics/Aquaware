...
class NitriteDataScreen extends StatefulWidget {
  final int aquariumId;

  NitriteDataScreen({required this.aquariumId});

  @override
  _NitriteDataScreenState createState() => _NitriteDataScreenState();
}

class _NitriteDataScreenState extends State<NitriteDataScreen> {
  ...
  Widget _makeLineChartWidget(List<WaterValue> waterValues) {
    ...
    double yDeviation = 0.1; // Example deviation for Nitrite
