...
class MolybdenumDataScreen extends StatefulWidget {
  final int aquariumId;

  MolybdenumDataScreen({required this.aquariumId});

  @override
  _MolybdenumDataScreenState createState() => _MolybdenumDataScreenState();
}

class _MolybdenumDataScreenState extends State<MolybdenumDataScreen> {
  ...
  Widget _makeLineChartWidget(List<WaterValue> waterValues) {
    ...
    double yDeviation = 0.05; // Example deviation for Molybdenum
    return LineChartWidget(
      xValues: xValues,
      yValues: yValues,
      yDeviation: yDeviation,
      fractionDigits: 3,
      title: 'Molybdenum Levels over Time',
      xAxisLabel: 'Time',
      yAxisLabel: 'Molybdenum (mg/L)',
    );
  }
  ...
  Widget _makeHeatmapWidget(List<WaterValue> waterValues) {
    return HeatmapWidget(
      ...
      fractionDigits: 3,
      title: "Molybdenum Level Heatmap",
    );
  }
}
