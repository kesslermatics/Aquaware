...
class CarbonateHardnessDataScreen extends StatefulWidget {
  ...
  @override
  _CarbonateHardnessDataScreenState createState() => _CarbonateHardnessDataScreenState();
}

class _CarbonateHardnessDataScreenState extends State<CarbonateHardnessDataScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Carbonate Hardness Data'),
        leading: IconButton(
