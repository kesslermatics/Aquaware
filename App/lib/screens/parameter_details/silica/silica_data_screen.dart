...
class SilicaDataScreen extends StatefulWidget {
  final int aquariumId;

  SilicaDataScreen({required this.aquariumId});

  @override
  _SilicaDataScreenState createState() => _SilicaDataScreenState();
}

class _SilicaDataScreenState extends State<SilicaDataScreen> {
  ...
  Widget _makeLineChartWidget(List<WaterValue> waterValues) {
    ...
    double yDeviation = 1.0; // Example deviation for Silica
    return LineChartWidget(
      xValues: xValues,
      yValues: yValues,
      yDeviation: yDeviation,
      fractionDigits: 2,
      title: 'Silica Levels over Time',
      xAxisLabel: 'Time',
      yAxisLabel: 'Silica (mg/L)',
    );
  }
