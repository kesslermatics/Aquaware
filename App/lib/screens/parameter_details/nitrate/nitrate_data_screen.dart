...
class NitrateDataScreen extends StatefulWidget {
  final int aquariumId;

  NitrateDataScreen({required this.aquariumId});

  @override
  _NitrateDataScreenState createState() => _NitrateDataScreenState();
}

class _NitrateDataScreenState extends State<NitrateDataScreen> {
  ...
  Widget _makeLineChartWidget(List<WaterValue> waterValues) {
    ...
    double yDeviation = 10.0; // Example deviation for Nitrate
