...
class PotassiumDataScreen extends StatefulWidget {
  final int aquariumId;

  PotassiumDataScreen({required this.aquariumId});

  @override
  _PotassiumDataScreenState createState() => _PotassiumDataScreenState();
}

class _PotassiumDataScreenState extends State<PotassiumDataScreen> {
  ...
  Widget _makeLineChartWidget(List<WaterValue> waterValues) {
    ...
    double yDeviation = 5.0; // Example deviation for Potassium
