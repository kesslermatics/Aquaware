...
class TotalOrganicCarbonDataScreen extends StatefulWidget {
  final int aquariumId;

  TotalOrganicCarbonDataScreen({required this.aquariumId});

  @override
  _TotalOrganicCarbonDataScreenState createState() => _TotalOrganicCarbonDataScreenState();
}

class _TotalOrganicCarbonDataScreenState extends State<TotalOrganicCarbonDataScreen> {
  ...
  Future<List<WaterValue>> _fetchWaterValues() async {
    return await _waterParameterService.fetchSingleWaterParameter(
        widget.aquariumId, 'Total Organic Carbon');
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Total Organic Carbon Data'),
        leading: IconButton(
