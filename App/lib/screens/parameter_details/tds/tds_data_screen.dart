...
class TDSDataScreen extends StatefulWidget {
  final int aquariumId;

  TDSDataScreen({required this.aquariumId});

  @override
  _TDSDataScreenState createState() => _TDSDataScreenState();
}

class _TDSDataScreenState extends State<TDSDataScreen> {
