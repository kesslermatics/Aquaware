...
class BromineDataScreen extends StatefulWidget {
  final int aquariumId;

  BromineDataScreen({required this.aquariumId});

  @override
  _BromineDataScreenState createState() => _BromineDataScreenState();
}

class _BromineDataScreenState extends State<BromineDataScreen> {
  ...
  Widget _makeLineChartWidget(List<WaterValue> waterValues) {
    ...
    double yDeviation = 0.5; // Example deviation for Bromine
    return LineChartWidget(
      xValues: xValues,
      yValues: yValues,
      yDeviation: yDeviation,
      fractionDigits: 2,
      title: 'Bromine Levels over Time',
      xAxisLabel: 'Time',
      yAxisLabel: 'Bromine (mg/L)',
    );
  }
