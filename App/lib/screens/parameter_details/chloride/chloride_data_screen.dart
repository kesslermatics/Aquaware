...
class ChlorideDataScreen extends StatefulWidget {
  final int aquariumId;

  ChlorideDataScreen({required this.aquariumId});

  @override
  _ChlorideDataScreenState createState() => _ChlorideDataScreenState();
}

class _ChlorideDataScreenState extends State<ChlorideDataScreen> {
  ...
  Widget _makeLineChartWidget(List<WaterValue> waterValues) {
    ...
    double yDeviation = 20.0; // Example deviation for Chloride
