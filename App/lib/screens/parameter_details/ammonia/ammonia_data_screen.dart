...
class AmmoniaDataScreen extends StatefulWidget {
  ...
  AmmoniaDataScreen({required this.aquariumId});

  @override
  _AmmoniaDataScreenState createState() => _AmmoniaDataScreenState();
}

class _AmmoniaDataScreenState extends State<AmmoniaDataScreen> {
  ...
  Widget _makeLineChartWidget(List<WaterValue> waterValues) {
    ...
    double yDeviation = 0.1; // Example deviation for Ammonia
