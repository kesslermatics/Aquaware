...
class IodineDataScreen extends StatefulWidget {
  final int aquariumId;

  IodineDataScreen({required this.aquariumId});

  @override
  _IodineDataScreenState createState() => _IodineDataScreenState();
}

class _IodineDataScreenState extends State<IodineDataScreen> {
  ...
  Widget _makeLineChartWidget(List<WaterValue> waterValues) {
    ...
    double yDeviation = 0.05; // Example deviation for Iodine
    return LineChartWidget(
      xValues: xValues,
      yValues: yValues,
      yDeviation: yDeviation,
      fractionDigits: 3,
      title: 'Iodine Levels over Time',
      xAxisLabel: 'Time',
      yAxisLabel: 'Iodine (mg/L)',
    );
  }
