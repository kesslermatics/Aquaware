# Generated by Django 4.2.13 on 2024-12-17 23:50
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(choices=[('hobby', 'Hobby'), ('advanced', 'Advanced'), ('premium', 'Premium')], max_length=50, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subscription_tier', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='users', to='users.subscriptiontier')),
